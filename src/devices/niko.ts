        ...
        addCustomClusterManuSpecificNikoConfig: () =>
            deviceAddCustomCluster("manuSpecificNikoConfig", {
                ...
                attributes: {
                    ...
                    attr_0x0101: {ID: 0x0101, type: Zcl.DataType.UINT8, write: true},
                    attr_0x0102: {ID: 0x0102, type: Zcl.DataType.UINT8, write: true},
                    attr_0x0103: {ID: 0x0103, type: Zcl.DataType.UINT8, write: true},

                    attr_0x0105: {ID: 0x0105, type: Zcl.DataType.BITMAP8, write: true},
                    attr_0x0106: {ID: 0x0106, type: Zcl.DataType.UINT8, write: true},

                    attr_0x0200: {ID: 0x0200, type: Zcl.DataType.UINT32, write: true},

                    attr_0x0506: {ID: 0x0506, type: Zcl.DataType.UINT8, write: true},
                    attr_0x0507: {ID: 0x0507, type: Zcl.DataType.UINT8, write: true},
        ...
        addCustomClusterManuSpecificNikoState: () =>
            deviceAddCustomCluster("manuSpecificNikoState", {
                ...
                attributes: {
                    ...
                    attr_0x0000: {ID: 0x0000, type: Zcl.DataType.UINT8, write: true},
